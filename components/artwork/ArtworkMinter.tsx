  ...
  if (mintEnabled) {
    return (
      <>
        ...
        {
          (!mintEnabled) && (
            <SmallTitle>Mint is Over!</SmallTitle>
          )
        }
        {
          (!address && mintEnabled) && (
            <SmallTitle>Connect wallet to mint!</SmallTitle>
          )
        }
        {
          (canClaim && address && mintEnabled) && (
            <ArtworkClaim artworkType={0} />
          )
        }
        {
          (!canClaim && address && mintEnabled) && (
            <ArtworkMint artworkType={0} />
          )
        }
      </>
    );
